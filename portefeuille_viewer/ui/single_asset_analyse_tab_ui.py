...
class Ui_SingleAssetAnalyseTab(object):
    def setupUi(self, SingleAssetAnalyseTab):
        ...
        self.buttonDeleteTestOrder.setGeometry(QRect(1270, 760, 121, 31))
        self.checkBoxAssetOrdersOnly = QCheckBox(self.widget)
        self.checkBoxAssetOrdersOnly.setObjectName(u"checkBoxAssetOrdersOnly")
        self.checkBoxAssetOrdersOnly.setGeometry(QRect(982, 766, 151, 20))
        ...
        self.checkBoxEnableTestOrders.setGeometry(QRect(842, 766, 121, 20))
        self.tableViewOptiesOpenPut = QTableView(self.widget)
        self.tableViewOptiesOpenPut.setObjectName(u"tableViewOptiesOpenPut")
        self.tableViewOptiesOpenPut.setGeometry(QRect(830, 590, 1081, 117))
        ...
        self.tableViewOptiesOpenCall.setGeometry(QRect(830, 460, 1081, 117))
        ...
        self.tableViewAandelen.setGeometry(QRect(830, 371, 431, 77))
        ...
        self.tableViewSprinters.setGeometry(QRect(1280, 370, 631, 78))
