...
class OptionChainRetrieverWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        self._asset_row_by_key: dict[str, int] = {}
    ...
    def _load_assets(self) -> None:
        ...
        self._asset_row_by_key = {}
        for row, asset in enumerate(self.assets):
            self._asset_row_by_key[asset.asset_rollup] = row
    ...
    def _append_result(self, result: AssetScanResult) -> None:
        ...
        if result.status == "success":
            asset_row = self._asset_row_by_key.get(result.asset_rollup)
