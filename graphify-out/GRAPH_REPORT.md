...
## Corpus Check
- 136 files · ~421,237 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2787 nodes · 6893 edges · 93 communities detected
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 1888 edges (avg confidence: 0.75)
...
Cohesion: 0.03
Nodes (52): ColoredPolarsTableModel, ColumnFilterPopup, HeaderFilterMenuMixin, Vereist in de host-widget:     - self.tableView: QTableView     - self._table_, Klik op de hele rij (niet alleen het checkboxvakje) toggelt de checkstate., ColoredPolarsTableModel, QDialog, QStyledItemDelegate (+44 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (42): CheckableSortItem, ScenarioManagerDialog, Geeft de Id's terug van alle aangevinkte rijen., MainWindow, _TabBarNoFocusRectStyle, commentEditing(), exportSnapshot(), openCommentColorMenu() (+34 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (78): TestApp, fetch_target(), FutureHistApp, FutureTarget, load_future_targets(), main(), parse_args(), save_df_to_access_temp() (+70 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (67): exchange_candidates_for_target(), fetch_target(), IndexTarget, load_index_targets(), main(), parse_args(), save_df_to_access_temp(), connect_access() (+59 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (139): hydrate_snapshots(), compact_float64(), Zet alle Float64 kolommen om naar Float32 om geheugen te besparen., hydrate_snapshots(), _aandelen_tv_totals_in_sync(), _append_metrics_log_to(), _append_projection_metrics(), _apply_env_defaults_from_settings() (+131 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (30): Ui_MainWindow, PolarsTableModel, Qt-model dat data rechtstreeks uit een Polars DataFrame toont.     Te gebruiken, Optioneel alternatieve header labels meegeven per kolomnaam., object, PolarsTableModel, PercentColoredPolarsModel, PortfolioValueTab (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (55): get_connection(), _create_table(), _fill_filter_combo(), GeneratedOptionOrdersDialog, MultiSelectFilterDialog, _norm_option_exp(), open_scenario_dialog(), _scenario_content_safe_df() (+47 more)
...
Cohesion: 0.03
Nodes (27): HeaderFilterMenuMixin, HighlightingPandasTableModel, _fmt(), LaatstTransactiesDialog, QTableWidget — Space togglet vinkje op huidige rij, sortering via header., _TransactiesTable, HighlightingPandasTableModel, MultiColFilterProxy (+19 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (103): normalize_numeric_columns(), parse_iso_date(), quantize_decimal(), aggregate_daily_transactions(), apply_split_price_correction(), attach_effective_close(), build_state_intervals(), compute_valuation() (+95 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (40): run_loop(), connect_access(), format_nl_3(), intrinsic_value(), load_latest_option_snapshot(), load_latest_underlying_close(), load_open_option_positions(), load_universe_map() (+32 more)
...
Cohesion: 0.04
Nodes (27): LiveAggregatorAandelen, Gespecialiseerde aggregator voor aandelen live data processing., clear_live_prices(), initialize_live_prices(), Update de centrale live_prices store.     new_prices: dict met als key asset_id, Reset de centrale live_prices store., Vul SNAPSHOT_STORE.live_prices altijd eerst met de laatste bekende prijzen uit d, start_live_price_updater() (+19 more)
...
Cohesion: 0.05
Nodes (9): Central application signals.      Keep this module minimal and free of project, Signals, OptieEindSortProxy, OptieEindTab, OptieEindTableModel, _state_classes_from_asset_types(), Ui_OptieEindTab, PandasTableModel (+1 more)
...
Cohesion: 0.07
Nodes (30): _clean(), DoorrolOrderIssue, find_orders_with_call_put_mix(), IssueApplier, load_doorrol_rows(), main(), _normalize_cp(), ReviewWindow (+22 more)
...
Cohesion: 0.31
Nodes (16): _apply_order_delta(), _base_row_template(), build_portfolio_value_scenario_overlay_df(), _empty_df_like_base(), _meta_lookup(), _norm_asset(), _normalize_numeric_target(), _price_lookup() (+8 more)
...
## Knowledge Gaps
- **199 isolated node(s):** `Standalone E2E helper to fetch executions from the last N days.     Returns a li`, `Laad config uit settings_shared.ini en settings_local.ini.`, `Sla huidige config gesplitst op naar shared en local.`, `Haal alle databases op als dictionary.`, `Haal naam van default database op.` (+194 more)
...
- **Thin community `Community 45`** (2 nodes): `delete_all_records()`, `1 C - delete temp stock price table.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (2 nodes): `AGENTS.md Graphify Rules`, `CLAUDE.md Graphify Rules`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `opties_open_projection_v2.py`, `Open Opties Tab`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 70`** (1 nodes): `Haal singleton settings manager op.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `Laad config uit settings_shared.ini en settings_local.ini.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `Sla huidige config gesplitst op naar shared en local.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `Haal alle databases op als dictionary.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `Haal naam van default database op.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `Voeg nieuwe database toe.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `Update database configuratie.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `Stel database in als default.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `Zet alle is_default flags naar false.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `Haal brokerlijst op uit settings.ini (comma-separated).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `Retourneer lijst van (priority, label, bg_hex, fg_hex) voor comment-kleuren.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `Map hex -> priority (int).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 83`** (1 nodes): `Sla comment-kleuren op naar user settings.          `colors` mag zijn:         -`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (1 nodes): `Haal singleton settings manager op.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (1 nodes): `Geeft de Id's terug van alle aangevinkte rijen.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `Handmatige kolombreedtes voor `testOrdersTable`.         Pas de dict hieronder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `Maak alleen deze tab scrollbaar (handig op laptop-schermen).          De UI va`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `Debug helper om cache/dirty status te loggen naar CLI.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `Klik op asset in test-orders tabel: stel asset_selector in en reload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `Sla bewerkte comment op en herlaad de tabellen zodat alle views synchroon blijve`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `Werk comment/timestamp bij in alle optie modellen zonder volledige reload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `Header-menu met extra sorteeropties op kleur voor de commentkolom.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `MainWindow` connect `Community 1` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 15`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `SingleAssetAnalyseTab` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `get_settings()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 20`?**
...
- **Are the 54 inferred relationships involving `get_settings()` (e.g. with `_apply_env_defaults_from_settings()` and `_aandelen_tv_totals_in_sync()`) actually correct?**
